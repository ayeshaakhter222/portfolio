                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('skill.store') }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="percentage" type="number" class="form-control @error('percentage') is-invalid @enderror" name="percentage" value="{{ old('percentage') }}" required autocomplete="percentage">
