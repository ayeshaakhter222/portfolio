                ...
                @foreach($categories as $key => $category)
                    <div class="col-lg-4">
                        <div class="categories_post">
                            <img src="img/blog/cat-post/cat-post-{{ $key+1 }}.jpg" alt="post">
                            ...
                            <div class="col-md-3">
                                <div class="blog_info text-right">
                                    ...
                                    <ul class="blog_meta list">
                                        ...
                                        <li><a href="#">{{ $post->total_comments }}<i class="lnr lnr-bubble"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-md-9">
                                <div class="blog_post">
                                    ...
                                    <div class="blog_details">
                                        ...
                                        <a href="{{ route('post.show', $post->id) }}" class="white_bg_btn">View More</a>
                                    </div>
                                </div>
                            </div>
                        </article>
